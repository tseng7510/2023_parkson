<nav class="mainMenu" itemscope itemtype="https://schema.org/siteNavigationElement">
  ...
  <ul>
    ...
    <li><button type="button">MEDIA</button>
      <div class="nextMenuBox">
        <ul class='class'>
          ...
          <li><a href="https://www.parkson-wu.com/showroom/en.html" target="_blank">Virtual Showroom</a></li>
        </ul>
        <div class="listBox">
          <div class='list'>
            <ul>
    ...
    <li class="small"><button type="button">COMPANY</button>
      <div class="nextMenuBox">
        <ul>
          <li><a href="about.php">Company</a></li>
          <li><a href="milestone.php">Awards & Milestone</a></li>
    ...
    <li class="small"><button type="button">CONTACT</button>
      <div class="nextMenuBox">
        <ul>
